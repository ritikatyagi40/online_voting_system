<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="online_voting_system.profile" %>
             ...
             <div class="container" style="width:50%;background-color:#00000099;">
               ...
               <div class="row" style=" width: 100%; height:20px;"></div>
                 <div class="row" style=" width: 100%; height:50px;">
                   <b style="color:red;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Please Enter  VoterId First</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBox7" runat="server" Height="18px" Width="229px" ></asp:TextBox>
                     <br />
                     <br />
               </div>
               <div class="row" style=" width: 100%; height:20px;"></div>
               ...
               <div class="row" style=" width: 100%; height:50px;">
                   <b style="color:white;">Age</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; <asp:TextBox ID="TextBox2" runat="server" Height="18px" Width="229px" ForeColor="black"></asp:TextBox>
               </div>
